...
export const MARKETS: MarketWithOptions[] = [
  ...
  },
  {
    ...
    description: null,
    status: 'resolved',
    winning_option: 'm-hielo-o1',
    result_note: null,
    result_set_at: agoHours(50),
    resolved_at: agoHours(49),
    closes_at: agoHours(52),
    created_at: agoHours(96),
    market_options: options('m-hielo', [
      ['Bruno', 2.2, 2.6, 90],
      ['Marcos', 1.7, 1.5, 210],
    ]),
  },
  {
    ...
    description: null,
    status: 'cancelled',
    cancel_reason: 'Al final pedimos pizzas',
    closes_at: agoHours(60),
    created_at: agoHours(110),
    market_options: options('m-paella', [
      ['Sí', 1.9, 1.9, 0],
      ['No', 1.9, 1.9, 0],
    ]),
  },
